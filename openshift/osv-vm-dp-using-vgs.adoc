...
.手順
. Red Hat のドキュメントの手順に従って、OpenShift クラスタバージョン 4.19 をインストールしてください： https://docs.redhat.com/en/documentation/openshift_container_platform/4.19#Install["OpenShift Container Platform のインストール"]。
