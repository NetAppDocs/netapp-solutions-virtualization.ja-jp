...
[role="lead"]
VMware とNetAppストレージ ソリューションの統合を紹介するビデオとデモをご覧ください。NetApp ONTAP Tools for VMware vSphere、 SnapCenter Plug-in for VMware vSphere、3-2-1 データ保護の使用方法、およびNetApp がVMware Cloud Foundation およびVMware vSphere Foundation と連携する仕組みについて説明します。
