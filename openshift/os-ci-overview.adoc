...
Cloud Insightsの使用を開始するには、 link:https://www.netapp.com/console["NetApp Console"]。詳細については、 link:https://docs.netapp.com/us-en/cloudinsights/task_cloud_insights_onboarding_1.html["Cloud Insightsオンボーディング"]
